...
export declare class Device extends Message<Device> {
  ...
  /**
   * @generated from field: repeated spotsie.device.v1.Session sessions = 5;
   */
  sessions: Session[];
  ...
  static readonly typeName = "spotsie.device.v1.Device";
...
export declare class Session extends Message<Session> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "spotsie.device.v1.Session";
  static readonly fields: FieldList;
