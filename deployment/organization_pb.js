...
export const GeoPoint = proto3.makeMessageType(
  "spotsie.deployment.v1.GeoPoint",
  () => [
...
export const MultilaterationConfig = proto3.makeMessageType(
  "spotsie.deployment.v1.MultilaterationConfig",
  () => [
...
export const PointConfig = proto3.makeMessageType(
  "spotsie.deployment.v1.PointConfig",
  () => [
...
export const Zone_Config = proto3.makeMessageType(
  "spotsie.deployment.v1.Zone.Config",
  () => [
...
export const Deployment = proto3.makeMessageType(
  "spotsie.deployment.v1.Deployment",
  () => [
    { no: 1, name: "id", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
...
export const Deployment_Type = proto3.makeEnum(
  "spotsie.deployment.v1.Deployment.Type",
  [
    {no: 0, name: "UNKNOWN"},
    {no: 1, name: "POINT"},
    {no: 2, name: "MULTILATERATION"},
  ],
);
...
export const PositioningReferent = proto3.makeMessageType(
  "spotsie.deployment.v1.PositioningReferent",
  () => [
    { no: 1, name: "id", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
...
export const PositioningReferent_DeviceType = proto3.makeEnum(
  "spotsie.deployment.v1.PositioningReferent.DeviceType",
  [
...
export const Organization = proto3.makeMessageType(
  "spotsie.deployment.v1.Organization",
  () => [
    { no: 1, name: "id", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    ...
    { no: 9, name: "members", kind: "scalar", T: 5 /* ScalarType.INT32 */, repeated: true },
    { no: 10, name: "positioning_referents", kind: "scalar", T: 5 /* ScalarType.INT32 */, repeated: true },
  ],
);
 ...
 */
export const Organization_Member = proto3.makeMessageType(
  "spotsie.deployment.v1.Organization.Member",
  () => [
    { no: 1, name: "user", kind: "message", T: User },
    { no: 2, name: "role", kind: "enum", T: proto3.getEnumType(Organization_Member_Role) },
  ],
  {localName: "Organization_Member"},
);

/**
 * @generated from enum spotsie.deployment.v1.Organization.Member.Role
 */
export const Organization_Member_Role = proto3.makeEnum(
  "spotsie.deployment.v1.Organization.Member.Role",
  [
