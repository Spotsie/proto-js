...
// @generated from file deployment/organization.proto (package spotsie.deployment.v1, syntax proto3)
/* eslint-disable */
/* @ts-nocheck */
...
/**
 * @generated from message spotsie.deployment.v1.GeoPoint
 */
export declare class GeoPoint extends Message<GeoPoint> {
  ...
  static readonly typeName = "spotsie.deployment.v1.GeoPoint";
...
/**
 * @generated from message spotsie.deployment.v1.MultilaterationConfig
 */
export declare class MultilaterationConfig extends Message<MultilaterationConfig> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "spotsie.deployment.v1.MultilaterationConfig";
  static readonly fields: FieldList;
...
/**
 * @generated from message spotsie.deployment.v1.PointConfig
 */
export declare class PointConfig extends Message<PointConfig> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "spotsie.deployment.v1.PointConfig";
  static readonly fields: FieldList;
...
/**
 * @generated from message spotsie.deployment.v1.Zone
 */
export declare class Zone extends Message<Zone> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "spotsie.deployment.v1.Zone";
  static readonly fields: FieldList;
...
/**
 * @generated from message spotsie.deployment.v1.Zone.Config
 */
export declare class Zone_Config extends Message<Zone_Config> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "spotsie.deployment.v1.Zone.Config";
  static readonly fields: FieldList;
...
/**
 * @generated from message spotsie.deployment.v1.Deployment
 */
export declare class Deployment extends Message<Deployment> {
  ...
  /**
   * @generated from field: spotsie.deployment.v1.Deployment.Type type = 5;
   */
  ...
  /**
   * @generated from oneof spotsie.deployment.v1.Deployment.locator_config
   */
  locatorConfig: {
    /**
     * @generated from field: spotsie.deployment.v1.MultilaterationConfig multilateration = 8;
     */
    value: MultilaterationConfig;
    case: "multilateration";
  } | {
    /**
     * @generated from field: spotsie.deployment.v1.PointConfig point = 9;
     */
    value: PointConfig;
    case: "point";
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "spotsie.deployment.v1.Deployment";
  static readonly fields: FieldList;
...
/**
 * @generated from enum spotsie.deployment.v1.Deployment.Type
 */
export declare enum Deployment_Type {
  ...
  /**
   * @generated from enum value: MULTILATERATION = 2;
   */
  MULTILATERATION = 2,
}

/**
 * @generated from message spotsie.deployment.v1.User
 */
export declare class User extends Message<User> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "spotsie.deployment.v1.User";
  static readonly fields: FieldList;
...
/**
 * @generated from message spotsie.deployment.v1.PositioningReferent
 */
export declare class PositioningReferent extends Message<PositioningReferent> {
  ...
  /**
   * @generated from field: spotsie.deployment.v1.PositioningReferent.DeviceType referent_type = 3;
   */
  ...
  /**
   * @generated from field: spotsie.deployment.v1.GeoPoint location = 5;
   */
  location?: GeoPoint;
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "spotsie.deployment.v1.PositioningReferent";
  static readonly fields: FieldList;
...
/**
 * @generated from enum spotsie.deployment.v1.PositioningReferent.DeviceType
 */
...
/**
 * @generated from message spotsie.deployment.v1.Organization
 */
export declare class Organization extends Message<Organization> {
  ...
  /**
   * @generated from field: repeated int32 members = 9;
   */
  members: number[];

  /**
   * @generated from field: repeated int32 positioning_referents = 10;
   */
  positioningReferents: number[];
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "spotsie.deployment.v1.Organization";
  static readonly fields: FieldList;
...
/**
 * @generated from message spotsie.deployment.v1.Organization.Member
 */
export declare class Organization_Member extends Message<Organization_Member> {
  /**
   * @generated from field: spotsie.deployment.v1.User user = 1;
   */
  user?: User;

  /**
   * @generated from field: spotsie.deployment.v1.Organization.Member.Role role = 2;
   */
  role: Organization_Member_Role;

  constructor(data?: PartialMessage<Organization_Member>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "spotsie.deployment.v1.Organization.Member";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): Organization_Member;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): Organization_Member;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): Organization_Member;

  static equals(a: Organization_Member | PlainMessage<Organization_Member> | undefined, b: Organization_Member | PlainMessage<Organization_Member> | undefined): boolean;
}

/**
 * @generated from enum spotsie.deployment.v1.Organization.Member.Role
 */
