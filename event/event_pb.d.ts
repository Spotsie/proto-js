...
import type {Beacon, DeploymentDto, GeoPoint, Observation, Subject} from "../domain/domain_pb.js";
...
export declare class BeaconObservationsEvent extends Message<BeaconObservationsEvent> {
  ...
  /**
   * @generated from field: repeated spotsie.domain.v1.Observation observations = 3;
   */
  ...
  static readonly typeName = "spotsie.event.v1.BeaconObservationsEvent";
...
export declare class BeaconObservationEvent extends Message<BeaconObservationEvent> {
  /**
   * @generated from field: spotsie.domain.v1.Observation observation = 1;
   */
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "spotsie.event.v1.BeaconObservationEvent";
  static readonly fields: FieldList;
...
export declare class SubjectLocationUpdateEvent extends Message<SubjectLocationUpdateEvent> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "spotsie.event.v1.SubjectLocationUpdateEvent";
  static readonly fields: FieldList;
...
export declare class DeploymentCreatedEvent extends Message<DeploymentCreatedEvent> {
  ...
  /**
   * @generated from field: spotsie.domain.v1.DeploymentDto model = 2;
   */
  model?: DeploymentDto;
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "spotsie.event.v1.DeploymentCreatedEvent";
  static readonly fields: FieldList;
...
export declare class DeploymentDeletedEvent extends Message<DeploymentDeletedEvent> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "spotsie.event.v1.DeploymentDeletedEvent";
  static readonly fields: FieldList;
...
export declare class DeploymentUpdatedEvent extends Message<DeploymentUpdatedEvent> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "spotsie.event.v1.DeploymentUpdatedEvent";
  static readonly fields: FieldList;
...
export declare class DeviceDiscovery extends Message<DeviceDiscovery> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "spotsie.event.v1.DeviceDiscovery";
  static readonly fields: FieldList;
